    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class=" main-nav nav ">
                ...
                <li><a href="#">LOẠI</a></li>
                <li><a href="#" onclick="loadInterface('/ban-hang-online/dien-thoai-thong-minh')">ĐIỆN THOẠI THÔNG
                    MINH</a></li>
            </ul>
            <!-- /NAV -->
        </div>
...
<main id="content">
    ...
    <div id="myModal">
        <div style="width: 20cm;height: 15cm">
            <img src="https://uploads-ssl.webflow.com/6073fad993ae97919f0b0772/609fa687874b84361fc495db_%C4%91t.jpg"
