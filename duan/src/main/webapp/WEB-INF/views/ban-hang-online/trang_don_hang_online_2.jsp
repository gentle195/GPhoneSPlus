...
<main style="width: 95%;margin-left: 2.5%; " id="content">
    <c:if test="${listhdkh.size()>0}">
        ...
        <div id="tab2" class="tab-content" style="display: block; color: red">

            <form action="/ban-hang-online-2/hoa-don-online/${id}/search" method="post">
...
<div align="center">
    <div class="btn-group" role="group" aria-label="Basic example">
        <ul class="pagination justify-content-center pagination-lg">
            <li class="page-item"><a class="page-link" href="/ban-hang-online-2/hoa-don-online/${idkhachhang}?pageNum=0"><</a></li>
            <c:forEach begin="1" end="${total}" varStatus="status">
                <li class="page-item">
                    <a href="${pageContext.request.contextPath}/ban-hang-online-2/hoa-don-online/${idkhachhang}?pageNum=${status.index -1}"
                       class="page-link">${status.index}</a>
                </li>
            </c:forEach>
            <li class="page-item"><a class="page-link" href="/ban-hang-online-2/hoa-don-online/${idkhachhang}?pageNum=${total-1}">></a></li>
        </ul>
    </div>
</div>
