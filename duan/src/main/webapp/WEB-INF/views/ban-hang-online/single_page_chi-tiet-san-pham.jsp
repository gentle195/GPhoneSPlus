                    ...
                    <div class="product-details">
                        ...
                        <div class="add-to-cart" style="margin-top: 7cm">
                            ...
                            <c:if test="${idkhachhang!='1'}">
                                ...
                                <button class="add-to-cart-btn" onclick="alert('Sản phẩm này đã ngừng bán')"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</button>


                                <button class="add-to-cart-btn" onclick="alert('Sản phẩm này đã ngừng bán')"><i class="fa fa-shopping-cart"></i> Mua ngay</button>
