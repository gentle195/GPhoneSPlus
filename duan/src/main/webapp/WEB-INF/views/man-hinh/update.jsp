...
<%--                                            <tbody>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="thongSo">Thông số màn hình</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:input path="thongSo"/>--%>
<%--                                                    <form:errors path="thongSo" cssClass="error text-danger"/></th>--%>
<%--                                            </tr>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="loaiCamUng">Loại cảm ứng màn hình</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:input path="loaiCamUng"/>--%>
<%--                                                    <form:errors path="loaiCamUng" cssClass="error text-danger"/></th>--%>
<%--                                            </tr>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="tiLeKhungHinh">Tỉ lệ khung hình</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:input path="tiLeKhungHinh"/>--%>
<%--                                                    <form:errors path="tiLeKhungHinh"--%>
<%--                                                                 cssClass="error text-danger"/></th>--%>
<%--                                            </tr>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="congNghe">Công nghệ màn hình</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:input path="congNghe"/>--%>
<%--                                                    <form:errors path="congNghe" cssClass="error text-danger"/></th>--%>
<%--                                            </tr>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="doPhanGiai">Độ phân giải</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:input path="doPhanGiai"/>--%>
<%--                                                    <form:errors path="doPhanGiai" cssClass="error text-danger"/></th>--%>
<%--                                            </tr>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="tanSoQuet">Tần số quét</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:input path="tanSoQuet"/>--%>
<%--                                                    <form:errors path="tanSoQuet" cssClass="error text-danger"/></th>--%>
<%--                                            </tr>--%>
<%--                                            <tr>--%>
<%--                                                <td style="text-align: center"><form:label--%>
<%--                                                        path="tinhTrang">Trạng thái</form:label></td>--%>
<%--                                                <th style="text-align: center"><form:radiobutton path="tinhTrang"--%>
<%--                                                                                                 value="0"--%>
<%--                                                                                                 label="Hoạt động"/>--%>
