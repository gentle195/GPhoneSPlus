...
<div>
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="hoa-don/hien-thi-xac-nhan"
               role="tab"
               aria-controls="description" aria-selected="true">Hóa đơn đã xác nhận</a>
        </li>
        <li class="nav-item">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="loc" style="color:black;">
                        <form:form action="/hoa-don/loc-xac-nhan" method="post" modelAttribute="hoaDon">
