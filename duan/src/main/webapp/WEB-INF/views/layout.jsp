            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="/chi-tiet-san-pham/hien-thi">Chi Tiết Sản
                                Phẩm</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" href="/dung-luong-pin/hien-thi">Dung Lượng Pin</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="icons">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/hang-khach-hang/hien-thi">Hạng Khách
                                Hàng</a></li>
