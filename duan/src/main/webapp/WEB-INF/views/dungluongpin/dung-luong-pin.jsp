...
<body>
<a href="/dung-luong-pin/view-add" class="btn btn-outline-primary"
   tabindex="-1"
   role="button"
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                ...
                <form action="/dung-luong-pin/search" method="post" style="float: right">
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach items="${list}" var="dlp">
                                    <tr>
                                        ...
                                        <td>${dlp.moTa}</td>
                                        <td>
                                            <a href="/dung-luong-pin/detail/${dlp.id}" class="btn btn-outline-primary"
                                               tabindex="-1"
                                               role="button"
                                               onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">Detail</a>
                                            <a href="/dung-luong-pin/delete/${dlp.id}" class="btn btn-outline-primary"
                                               tabindex="-1"
                                               role="button"
