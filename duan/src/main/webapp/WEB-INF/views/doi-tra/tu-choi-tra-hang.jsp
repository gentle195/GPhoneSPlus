...
<div>
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="/doi-tra/hien-thi-tu-choi-tra" role="tab" aria-controls="description" aria-selected="true">Từ chối trả hàng </a>
        </li>
        <li class="nav-item">
