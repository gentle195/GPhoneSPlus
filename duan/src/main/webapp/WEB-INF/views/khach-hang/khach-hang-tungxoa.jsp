...
<body>
<%--<a href="/khach-hang/view-add" class="btn btn-primary" style="float: right" >khôi phục 1 phần</a>--%>

<a href="/khach-hang/khoi-phuc-het" class="btn btn-danger" style="float: right" >Khôi phục hết</a>

<a href="/khach-hang/hien-thi" class="btn btn-danger" style="float: right" >Quoay về</a>

<form action="/khach-hang/tim-kiem-tung-xoa" method="post" style="margin-left: 1cm">
    ...
    <div class="col-md-12 col-sm-12 ">
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach items="${dulieu}" var="ht" varStatus="stt">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/khach-hang/khoi-phuc/${ht.id}" class="btn btn-success" onclick="return tbxd()">Khôi phục
                                            </a>
                                        </td>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center pagination-lg">
                <li class="page-item"><a class="page-link" href="/khach-hang/khach-hang-tung-xoa?num=0">First</a></li>
                ...
                <li class="page-item"><a class="page-link" href="/khach-hang/khach-hang-tung-xoa?num=${total-1}">Last</a></li>
            </ul>
        </nav>
