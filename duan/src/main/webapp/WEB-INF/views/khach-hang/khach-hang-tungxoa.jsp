...
<a href="/khach-hang/khoi-phuc-het" class="btn btn-danger" style="float: right" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;" >Khôi phục hết</a>
...
<br>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center pagination-lg">
                <li class="page-item"><a class="page-link" href="/khach-hang/khach-hang-tung-xoa?num=0"> <</a></li>
                ...
                <li class="page-item"><a class="page-link" href="/khach-hang/khach-hang-tung-xoa?num=${total-1}"> ></a></li>
            </ul>
        </nav>
