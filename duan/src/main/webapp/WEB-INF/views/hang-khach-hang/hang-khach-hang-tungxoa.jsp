...
<div style="border: 4px solid #9cc2cb;width: 90%;margin-left: 5%;height: 50cm">
    ...
    <div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a role="tab"  href="/hang-khach-hang/hien-thi">
...
<%--                   data-toggle="tab"--%>
    ...
    <div class="">
        ...
        <div class="x_panel">
            <div class="x_title">
                <a href="/hang-khach-hang/hang-khach-hang-tungxoa/khoi-phuc-het" class="btn btn-danger" style="float: right" >Khôi phục hết</a>

                <form action="/hang-khach-hang/tim-kiem-tung-xoa" method="post" style="margin-right: 15cm; float: right">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center pagination-lg">
            <li class="page-item"><a class="page-link" href="/hang-khach-hang/hang-khach-hang-tung-xoa?num=0">First</a></li>
            ...
            <li class="page-item"><a class="page-link" href="/hang-khach-hang/hang-khach-hang-tung-xoa?num=${total-1}">Last</a></li>
        </ul>
    </nav>
