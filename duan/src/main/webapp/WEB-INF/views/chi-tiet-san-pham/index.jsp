...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="description" role="tabpanel"
        ...
        <div class="modal fade" id="hienThiLoc" tabindex="-1" aria-labelledby="hienThiLocLable" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <form action="/chi-tiet-san-pham/loc" method="post" onsubmit="return checkLoc()">
                            <table class="table">
                                <tr>
                                    <th style="text-align: center" colspan="1">Hãng Điện Thoại</th>
                                    <th style="text-align: center" colspan="1">Ram</th>
                                    <th style="text-align: center" colspan="1">Dung Lượng Bộ Nhớ</th>
                                    <th style="text-align: center" colspan="1">Dung Lượng Pin</th>
                                    <th style="text-align: center" colspan="1">Chip</th>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align: center" colspan="1">
                                        <select name="dungLuongPin" class="form-control" style="font-weight: bold; width: 100%">
                                ...
                                <tr>
                                    <th style="text-align: center" colspan="2">Màn Hình</th>
                                    <th style="text-align: center" colspan="1">Camera</th>
                                    <th style="text-align: center" colspan="1">Giá Bán Min</th>
                                    <th style="text-align: center" colspan="1">Giá bán Max</th>
                                </tr>
                                <tr>
