    ...
    <div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                ...
                <a href="/dia-chi/hien-thi" role="tab" >
...
<%--                                   data-toggle="tab"--%>
    ...
    <form:form action="/dia-chi/update" method="post" modelAttribute="dc" id="formlink">
        ...
        <div style="border: 2px solid #9cc2cb; padding: 10px; position: relative;float: right;width: 10%;margin-right: 5%;height: 12cm">
        ...
        <div style="border: 2px solid #9cc2cb; padding: 10px; position: relative;width: 75%;margin-left: 5%;height: 12cm">
            ...
            <div >
                <table class="table" style="height: 100%">
                    ...
                    <P style="text-align: center;font-size: 20px">MÃ ĐỊA CHỈ :<label style="color: red;">${dc.ma}</label></P>
        ...
        <div class="x_panel">
            <div class="x_title">
                <div align="center" style="float: right;margin-right: 20cm">
                    <form action="/dia-chi/tim-kiem/${dc.id}" method="post" style="margin-left: 1cm;">
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach items="${dulieu}" var="ht" varStatus="stt">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/dia-chi/remove/${ht.id}/${dc.id}" class="btn btn-success" onclick="return tb()">Xóa</a>
